 ...
 */
class BBEProcessor : public DspEffect {
public:
    /**
     * @brief Default constructor
     *
     * Creates BBE processor in disabled state with default parameters:
     * - Definition: 25% (32/127)
     * - Bass boost: ~6% (8/127)
     * - Enabled: false
     *
    ...
    /**
     * @brief Initialize processor for given sample rate and block size
     *
     ...
     * @param maxBlockSize Maximum block size (unused, BBE uses thread_local buffers)
     ...
     * 
     * @warning If disabled, function returns immediately (zero overhead)
     */
     ...
     * @note Does not reset parameters (definition, bass, enabled)
     */
    void reset() noexcept override;

    /**
     * @brief Enable/disable BBE processing
     * @param enabled true = processing active, false = bypass
